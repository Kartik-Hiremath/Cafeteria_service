...
from app import models  # noqa: F401 - needed for Base.metadata.create_all
from app.routes import admin, auth, reservations
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[FRONTEND_URL, "http://localhost:3000","https://cafeteria-service.onrender.com"],
